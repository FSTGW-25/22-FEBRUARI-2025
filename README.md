...
<body>
  <div class="title-box">23 Hari Lagi Kak Thania Theresia Podung Ulang Tahun! 🎉🎂🥳</div>
  ...
  <div id="photo-gallery" class="photo-gallery" style="display: none;">
    <div class="gallery-container">
      <img src="foto 6.jpeg" class="gallery-photo">
    </div>
  </div>

  <script>
    const audio = new Audio('Seventeen- Circles.mp3');
    ...
    const fullMessage = `Seperti lingkaran yang tidak memiliki ujung, perjalanan dalam hidup juga tidak selalu tentang mencapai garis akhir, tetapi tentang bagaimana setiap langkah dijalani 🌈. Tidak perlu terburu-buru mencari semua jawaban, karena setiap pertanyaan akan terjawab pada waktunya 🌼. Jangan ragu untuk melangkah meski arah belum jelas, karena setiap langkah membawa lebih dekat pada tujuan 🌻. Yang terpenting adalah terus bergerak, belajar, dan tumbuh tanpa henti 🌸🤍.`;
